...
export default function OnboardingModal({ userId, onClose }: { userId: string; onClose: () => void }) {
    ...
    return (
        <div className="fixed inset-0 z-[90] flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
            ...
            <div className="relative w-full max-w-md rounded-xl border border-[rgb(var(--accent-rgb)/0.2)] bg-[#0a1120] p-6" style={{ boxShadow: "0 0 60px -12px rgb(var(--accent-rgb) / 0.3)" }}>
                ...
                {step === 1 && (
                    <div>
                        ...
                        <p className="text-[10px] font-mono tracking-[0.2em] text-[rgb(var(--accent-light-rgb)/0.6)] mb-1">STEP 1 OF 4</p>
                ...
                {step === 2 && (
                    <div>
                        <p className="text-[10px] font-mono tracking-[0.2em] text-[rgb(var(--accent-light-rgb)/0.6)] mb-1">STEP 2 OF 4</p>
                ...
                {step === 3 && (
                    <div>
                        <p className="text-[10px] font-mono tracking-[0.2em] text-[rgb(var(--accent-light-rgb)/0.6)] mb-1">STEP 3 OF 4</p>
                ...
                {step === 4 && (
                    <div>
                        <p className="text-[10px] font-mono tracking-[0.2em] text-[rgb(var(--accent-light-rgb)/0.6)] mb-1">STEP 4 OF 4</p>
                        ...
                        <button onClick={handleGoToSchedule} disabled={saving} className="w-full text-sm font-bold py-3.5 rounded-lg bg-[rgb(var(--accent-rgb))] text-black hover:bg-[rgb(var(--accent-light-rgb))] disabled:opacity-50 transition" style={{ boxShadow: "0 0 20px -4px rgb(var(--accent-rgb) / 0.6)" }}>
                ...
                {step < 4 && (
                    <div className="flex items-center justify-between mt-6">
                        ...
                        <button onClick={handleNext} className="flex items-center gap-1.5 text-sm font-mono font-bold px-5 py-2.5 rounded-lg bg-[rgb(var(--accent-rgb))] text-black hover:bg-[rgb(var(--accent-light-rgb))] transition">
