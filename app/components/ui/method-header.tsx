  ...
  return (
    <div className="flex items-center gap-3 mb-1">
      <button
        ...
        className="flex items-center gap-0.5 text-[10px] font-mono text-[var(--fg-30)] hover:text-[var(--fg-60)] transition shrink-0 -ml-1"
      >
        <ChevronLeft size={14} />
        {backLabel}
      </button>
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-[10px] font-mono font-semibold tracking-wide transition ${
                active
                  ...
                  : "text-[var(--fg-30)] hover:text-[var(--fg-50)] hover:bg-[var(--fg-03)]"
              }`}
            >
              {tab.label}
            </button>
