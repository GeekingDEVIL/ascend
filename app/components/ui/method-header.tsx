  ...
  return (
    <div className="flex items-center gap-3 mb-1">
      <button
        ...
        className="flex items-center gap-0.5 text-[10px] font-mono text-[rgb(var(--fg-rgb)/0.30)] hover:text-[rgb(var(--fg-rgb)/0.60)] transition shrink-0 -ml-1"
      >
        <ChevronLeft size={14} />
        {backLabel}
      </button>
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-[10px] font-mono font-semibold tracking-wide transition ${
                active
                  ...
                  : "text-[rgb(var(--fg-rgb)/0.30)] hover:text-[rgb(var(--fg-rgb)/0.50)] hover:bg-[rgb(var(--fg-rgb)/0.03)]"
              }`}
            >
              {tab.label}
            </button>
