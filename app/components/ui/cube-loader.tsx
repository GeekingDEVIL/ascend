...
export default function CubeLoader({ message }: { message?: string }) {
  return (
    <div className='flex flex-col items-center justify-center gap-12 p-12 min-h-[400px] perspective-container'>
