        ...
        <main className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] pb-24 md:pb-10 relative">
            ...
            <div className="relative z-10 max-w-xl mx-auto px-4 pt-6 space-y-5">
                ...
                <div>
                    ...
                    <p className="text-[11px] text-[var(--fg-30)] mt-0.5">Track your training journey</p>
                </div>
                                            ...
                                            {(() => {
                                                ...
                                                return (
                                                    <div className="space-y-4">
                                                        {groups.map((group) => (
                                                            <div key={group.label}>
                                                                <p className="text-[8px] font-mono tracking-widest text-[var(--fg-15)] mb-2">{group.label.toUpperCase()}</p>
                                                                <div className="space-y-1.5">
                                                                    {group.items.map((s) => (
                                                                        <div key={s.id} className="group flex items-center gap-3 rounded-xl border border-[var(--fg-06)] bg-[var(--fg-02)] hover:bg-[var(--fg-04)] hover:border-[var(--fg-10)] px-3.5 py-3 transition-all">
                                                    ...
                                                    <div key={pr.exercise_id}>
                                                        ...
                                                        >
                                                            ...
                                                            <div className="flex items-center gap-3 shrink-0">
                                                                <div className="text-right">
                                                                    <p className="text-sm font-bold font-mono text-[var(--fg-90)]">{Math.round(kgToUnit(pr.best_weight, weightUnit) * 10) / 10}<span className="text-[10px] text-[var(--fg-40)]">{weightUnit}</span> × {pr.best_reps_at_weight}</p>
                            ...
                            <motion.div key="body" className="space-y-4" variants={tabContent} initial="hidden" animate="visible" exit="exit">
                                ...
                                <div className="rounded-lg border border-[rgb(var(--accent-rgb)/0.15)] bg-[var(--fg-02)] p-4" style={{ boxShadow: "inset 0 1px 0 rgb(var(--accent-rgb) / 0.06)" }}>
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        />
                                        <span className="shrink-0 text-[10px] font-mono px-3 py-3 text-[var(--fg-40)]">{weightUnit.toUpperCase()}</span>
                                        <button
                                ...
                                <div className="rounded-lg border border-[rgb(var(--accent-rgb)/0.15)] bg-[var(--fg-02)] p-4" style={{ boxShadow: "inset 0 1px 0 rgb(var(--accent-rgb) / 0.06)" }}>
                                    ...
                                    {bodyWeightData.length >= 2 && !bodyWeightData.some((d) => d.ema) && (
                                        <p className="text-[9px] font-mono text-[var(--fg-20)] mt-2 text-center">Log morning weigh-ins to see the EMA<InfoTip term="EMA" /> trend line</p>
                                    )}
                                </div>
                            ...
                            <motion.div key="intake" className="space-y-4" variants={tabContent} initial="hidden" animate="visible" exit="exit">
                                ...
                                {(() => {
                                    ...
                                    return (
                                        <div className="rounded-lg border border-[rgb(var(--accent-rgb)/0.15)] bg-[var(--fg-02)] p-4" style={{ boxShadow: "inset 0 1px 0 rgb(var(--accent-rgb) / 0.06)" }}>
                                            <div className="flex items-center justify-between mb-3">
                                                <p className="text-[10px] font-mono tracking-widest text-[var(--fg-25)]">{isToday ? "TODAY'S PROGRESS" : "DAILY TOTALS"}</p>
                                                {intakeAdherence !== null && (
                                                    <p className="text-[9px] font-mono text-[var(--fg-30)]">30D ADHERENCE: <span className={intakeAdherence >= 80 ? "text-emerald-300" : intakeAdherence >= 50 ? "text-amber-300" : "text-red-300"}>{intakeAdherence}%</span></p>
                                                )}
                                            </div>
                                            ...
                                            {target > 0 && (
                                                <div className="mb-3">
                                                    <div className="h-3 rounded-full bg-[var(--fg-06)] overflow-hidden flex">
                                                        {mealTotals.map((m) => (
                                                            <div
                                                                key={m.slot}
                                                        ...
                                                        <div className="flex gap-2">
                                                            {mealTotals.map((m) => (
                                                                <div key={m.slot} className="flex items-center gap-1">
                                                                    ...
                                                                    <span className="text-[7px] font-mono text-[var(--fg-25)] capitalize">{m.slot} {m.kcal}</span>
                                                                </div>
                                                            ))}
                                                        </div>
                                                        <span className="text-[7px] font-mono text-[var(--fg-20)]">{totals.kcal} / {target}</span>
                                                    </div>
                                                </div>
                                            )}
                                                    ...
                                                    {([
                                                        ...
                                                        return (
                                                            <div key={m.label} className="text-center">
                                                                <p className="text-[7px] font-mono text-[var(--fg-30)] mb-0.5">{m.label}</p>
                                                                ...
                                                                <p className="text-[8px] font-mono mt-0.5" style={{ color: m.color }}>{Math.round(m.current)}<span className="text-[var(--fg-20)]">/{m.target}g</span></p>
                                                            </div>
                                                        );
                                                    })}
                                                </div>
                                            ...
                                            {!target && (
                                                <div className="grid grid-cols-4 gap-2">
                                                    <div className="text-center">
                                                        <p className="text-[8px] font-mono text-[var(--fg-30)]">KCAL</p>
