  ...
  return (
    <main className="relative min-h-screen w-full bg-[#050914] text-white p-4 md:p-10 pb-24 md:pb-10 overflow-x-hidden">
      ...
      <div className="relative z-10 w-full max-w-3xl mx-auto space-y-5">
        ...
        <div className="rounded-lg border border-cyan-400/15 bg-white/[0.03] p-10 text-center">
          <div className="w-14 h-14 mx-auto mb-5 rounded-full bg-cyan-400/15 border border-cyan-300/30 flex items-center justify-center" style={{ boxShadow: "0 0 25px -4px rgba(34,211,238,0.5)" }}>
            <Sparkles size={26} className="text-cyan-300" />
          </div>
          <p className="text-[10px] font-mono tracking-[0.3em] text-cyan-300/70 mb-2">COMING SOON</p>
