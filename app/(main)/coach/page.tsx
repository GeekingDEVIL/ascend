  ...
  return (
    <main className="relative min-h-screen w-full bg-[var(--bg-primary)] text-[var(--text-primary)] p-4 md:p-10 pb-24 md:pb-10 overflow-x-hidden">
      ...
      <div className="relative z-10 w-full max-w-3xl mx-auto space-y-5">
        ...
        <div>
          <h1 className="text-xl md:text-2xl font-bold tracking-wide text-[rgb(var(--fg-rgb)/0.90)]">AI Coach</h1>
          <p className="text-[rgb(var(--fg-rgb)/0.40)] text-sm mt-0.5">Your personal training advisor.</p>
        </div>

        <div className="rounded-lg border border-[rgb(var(--accent-rgb)/0.15)] bg-[rgb(var(--fg-rgb)/0.03)] p-10 text-center">
          ...
          <p className="text-lg font-bold text-[rgb(var(--fg-rgb)/0.90)] mb-2">AI Coach is training up.</p>
          <p className="text-sm text-[rgb(var(--fg-rgb)/0.40)] max-w-sm mx-auto">
