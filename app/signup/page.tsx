...
export default function SignupPage() {
  ...
  if (submitted) {
    return (
      <AuthCard>
        <h1 className="text-center text-lg font-bold tracking-wide text-[rgb(var(--accent-light-rgb))]">Check Your Email</h1>
        <DividerWithHyphens />
  ...
  if (mode === "email") {
    return (
      <AuthCard>
        ...
        <h1 className="text-center text-lg font-bold tracking-wide text-[rgb(var(--accent-light-rgb))]">Sign Up with Email</h1>
        <DividerWithHyphens />
  ...
  return (
    <AuthCard>
      <h1 className="text-center text-lg font-bold tracking-wide text-[rgb(var(--accent-light-rgb))]">Create Account</h1>
      <DividerWithHyphens />
      ...
      <p className="text-center text-white/40 text-xs">
        ...
        <a href="/login" className="text-[rgb(var(--accent-light-rgb))] hover:underline">Log in</a>
      </p>
    </AuthCard>
  );
}